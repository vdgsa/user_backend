...
COUNTRY_STATE_MAPPING = {
    ...
    ('Argentina', ''): ('Argentina', ''),
     ...
     ('', 'WV'): ('United States', 'WV'),
     ('', 'WY'): ('United States', 'WY'),
     ('US', 'AE'): ('United States', 'AE'),
     ('US', 'AK'): ('United States', 'AK'),
     ('US', 'AL'): ('United States', 'AL'),
     ('US', 'AR'): ('United States', 'AR'),
     ('US', 'AZ'): ('United States', 'AZ'),
     ('US', 'CA'): ('United States', 'CA'),
     ('US', 'CO'): ('United States', 'CO'),
     ('US', 'CT'): ('United States', 'CT'),
     ('US', 'DC'): ('United States', 'DC'),
     ('US', 'DE'): ('United States', 'DE'),
     ('US', 'FL'): ('United States', 'FL'),
     ('US', 'Florida'): ('United States', 'FL'),
     ('US', 'GA'): ('United States', 'GA'),
     ('US', 'HI'): ('United States', 'HI'),
     ('US', 'IA'): ('United States', 'IA'),
     ('US', 'ID'): ('United States', 'ID'),
     ('US', 'IL'): ('United States', 'IL'),
     ('US', 'IN'): ('United States', 'IN'),
     ('US', 'KS'): ('United States', 'KS'),
     ('US', 'KY'): ('United States', 'KY'),
     ('US', 'LA'): ('United States', 'LA'),
     ('US', 'MA'): ('United States', 'MA'),
     ('US', 'MD'): ('United States', 'MD'),
     ('US', 'ME'): ('United States', 'ME'),
     ('US', 'MI'): ('United States', 'MI'),
     ('US', 'MN'): ('United States', 'MN'),
     ('US', 'MO'): ('United States', 'MO'),
     ('US', 'MS'): ('United States', 'MS'),
     ('US', 'MT'): ('United States', 'MT'),
     ('US', 'NC'): ('United States', 'NC'),
     ('US', 'NE'): ('United States', 'NE'),
     ('US', 'NH'): ('United States', 'NH'),
     ('US', 'NJ'): ('United States', 'NJ'),
     ('US', 'NM'): ('United States', 'NM'),
     ('US', 'NV'): ('United States', 'NV'),
     ('US', 'NY'): ('United States', 'NY'),
     ('US', 'OH'): ('United States', 'OH'),
     ('US', 'OK'): ('United States', 'OK'),
     ('US', 'OR'): ('United States', 'OR'),
     ('US', 'Ohio'): ('United States', 'OH'),
     ('US', 'PA'): ('United States', 'PA'),
     ('US', 'PR'): ('United States', 'PR'),
     ('US', 'RI'): ('United States', 'RI'),
     ('US', 'SC'): ('United States', 'SC'),
     ('US', 'TN'): ('United States', 'TN'),
     ('US', 'TX'): ('United States', 'TX'),
     ('US', 'UT'): ('United States', 'UT'),
     ('US', 'VA'): ('United States', 'VA'),
     ('US', 'VT'): ('United States', 'VT'),
     ('US', 'WA'): ('United States', 'WA'),
     ('US', 'WI'): ('United States', 'WI'),
     ('US', 'WV'): ('United States', 'WV'),
     ('US', 'WY'): ('United States', 'WY'),
