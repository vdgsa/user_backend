...
class Migration(migrations.Migration):
    ...
    replaces = [('conclave_registration', '0001_squashed_0010_auto_20210422_2041'), ('conclave_registration', '0002_auto_20210425_1508'), ('conclave_registration', '0003_auto_20210427_2236'), ('conclave_registration', '0004_auto_20210428_1417'), ('conclave_registration', '0005_auto_20210428_1603'), ('conclave_registration', '0006_auto_20210428_1607'), ('conclave_registration', '0007_conclaveregistrationconfig_photo_release_text'), ('conclave_registration', '0008_auto_20210428_1840')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_period_time_label', models.CharField(blank=True, max_length=255)),
                ('fourth_period_time_label', models.CharField(blank=True, max_length=255)),
                ('second_period_time_label', models.CharField(blank=True, max_length=255)),
                ('third_period_time_label', models.CharField(blank=True, max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Class',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.CharField(choices=[('regular', 'Regular Curriculum (part- and full-time)'), ('beginners', 'Beginner Programs (both teen and adult)'), ('consort_coop', 'Consort Cooperative'), ('seasoned_players', 'Seasoned Players'), ('advanced_projects', 'Advanced Projects'), ('exhibitor', 'Vendors'), ('faculty_guest_other', 'Faculty/Guest/Other')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buddy_willingness', models.TextField(blank=True, choices=[('yes', 'Yes'), ('no', 'No'), ('maybe', 'Maybe')])),
