...
from vdgsa_backend.conclave_registration.models import (
    BEGINNER_PROGRAMS, ConclaveRegistrationConfig, RegistrationEntry
)
    ...
    for entry in entries:
        ...
        writer.writerow({
            ...
            **instruments_to_dict(entry),
            ...
            'CLASSES': '',
            'comments': (
                entry.regular_class_choices.comments
                if hasattr(entry, 'regular_class_choices') else ''),
            'period1_choice1': (
                entry.regular_class_choices.period1_choice1
                if hasattr(entry, 'regular_class_choices') else ''),
            'period1_choice1_instrument': (
                entry.regular_class_choices.period1_choice1_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period1_choice2': (
                entry.regular_class_choices.period1_choice2
                if hasattr(entry, 'regular_class_choices') else ''),
            'period1_choice2_instrument': (
                entry.regular_class_choices.period1_choice2_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period1_choice3': (
                entry.regular_class_choices.period1_choice3
                if hasattr(entry, 'regular_class_choices') else ''),
            'period1_choice3_instrument': (
                entry.regular_class_choices.period1_choice3_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period2_choice1': (
                entry.regular_class_choices.period2_choice1
                if hasattr(entry, 'regular_class_choices') else ''),
            'period2_choice1_instrument': (
                entry.regular_class_choices.period2_choice1_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period2_choice2': (
                entry.regular_class_choices.period2_choice2
                if hasattr(entry, 'regular_class_choices') else ''),
            'period2_choice2_instrument': (
                entry.regular_class_choices.period2_choice2_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period2_choice3': (
                entry.regular_class_choices.period2_choice3
                if hasattr(entry, 'regular_class_choices') else ''),
            'period2_choice3_instrument': (
                entry.regular_class_choices.period2_choice3_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period3_choice1': (
                entry.regular_class_choices.period3_choice1
                if hasattr(entry, 'regular_class_choices') else ''),
            'period3_choice1_instrument': (
                entry.regular_class_choices.period3_choice1_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period3_choice2': (
                entry.regular_class_choices.period3_choice2
                if hasattr(entry, 'regular_class_choices') else ''),
            'period3_choice2_instrument': (
                entry.regular_class_choices.period3_choice2_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period3_choice3': (
                entry.regular_class_choices.period3_choice3
                if hasattr(entry, 'regular_class_choices') else ''),
            'period3_choice3_instrument': (
                entry.regular_class_choices.period3_choice3_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period4_choice1': (
                entry.regular_class_choices.period4_choice1
                if hasattr(entry, 'regular_class_choices') else ''),
            'period4_choice1_instrument': (
                entry.regular_class_choices.period4_choice1_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period4_choice2': (
                entry.regular_class_choices.period4_choice2
                if hasattr(entry, 'regular_class_choices') else ''),
            'period4_choice2_instrument': (
                entry.regular_class_choices.period4_choice2_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            'period4_choice3': (
                entry.regular_class_choices.period4_choice3
                if hasattr(entry, 'regular_class_choices') else ''),
            'period4_choice3_instrument': (
                entry.regular_class_choices.period4_choice3_instrument
                if hasattr(entry, 'regular_class_choices') else ''),
            ...
            'has_done_work_study': (
                entry.work_study.has_done_work_study if hasattr(entry, 'work_study') else ''),
            'student_info': (
                entry.work_study.student_info if hasattr(entry, 'work_study') else ''),
            'job_preferences': (
                entry.work_study.job_preferences if hasattr(entry, 'work_study') else ''),
            'relevant_job_experience': (
                entry.work_study.relevant_job_experience if hasattr(entry, 'work_study') else ''),
            'other_skills': (
                entry.work_study.other_skills if hasattr(entry, 'work_study') else ''),
            'other_info': (
                entry.work_study.other_info if hasattr(entry, 'work_study') else ''),
